...
request_body = {
  "sentence": "There will be several rainy seasons in Eastern and Uva provinces and Polonnaruwa, Matale and Nuwara Eliya districts. Light rain may occur in Northern Province and Anuradhapura district. Rain or thundershowers may occur at a few places in Western and Sabaragamuwa provinces and Galle and Matara districts after around 2.00 pm. Moderate gusty winds of around 30-40 kmph can be expected at times in Central, Uva and Eastern Provinces. Foggy conditions can be expected in Western and Sabaragamuwa provinces and Galle and Matara districts in the morning."
}
